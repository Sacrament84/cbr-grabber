                ...
                dir ('cbr-backend') {
                     withSonarQubeEnv('sonarqube') {
                         container('sonar-scanner') {
                             sh """
                             sonar-scanner -Dsonar.sources=/home/jenkins/agent/workspace/cbr-grabber_dev/ -Dsonar.projectKey=cbr-grabber-staging -Dsonar.projectBaseDir=/home/jenkins/agent/workspace	
                             """
                        } 
                    }
                }
